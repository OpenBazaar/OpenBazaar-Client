...
module.exports = function(primaryColor, secondaryColor, backgroundColor, textColor) {
  ...
  customStyleTag.innerHTML +=
      "#ov1 #userPage .custCol-primary-light { transition: all .3s cubic-bezier(0, 0, 0.0, 1);  background-color: " + shadeColor2(primaryColor, 0.05) + ";}" +
      "#ov1 #userPage .custCol-primary, #ov1 #userPage .chosen-drop, #ov1 #userPage .no-results { transition: all .3s cubic-bezier(0, 0, 0.0, 1); background: " + primaryColor + ";}" +
      "#ov1 #userPage .btn-tab.active { transition: all .3s cubic-bezier(0, 0, 0.0, 1); background-color: " + primaryColor + ";}" +
      ...
      "#ov1 #userPage .custCol-secondary { transition: all .3s cubic-bezier(0, 0, 0.0, 1); background-color: " + secondaryColor + ";}" +
