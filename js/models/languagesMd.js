  ...
  defaults: {
    languages: [
      ...
      },
      {
        ...
        ShipToPostalCode: "Buque de código postal",
...
},
      {
        ...
        ReturnPolicyPlaceholder: "Rückgabebedingungen eingeben...",
        CategoryPlaceholder: "Kategorie eingeben",
        CategoryHelperText: "Kategorien werden benutzt um Gegenstände in deinem Laden zu gruppieren und organisieren",
        KeywordsHelperText: "Stichwörter zu setzen, hilft deinen Gegenstand im Markt zu finden.",
        ExpirationDateHelperText: "Setze ein Datum, an dem dein Gegenstand automatisch gelöscht werden soll.",
        ClearExpirationDate: "Lösche das Verfalldatum",
        ...
        YourName: "Dein Name",
        BitcoinReturnAddress: "Bitcoin Rücksendeaddresse",
        ...
        errorMessages: {
          ...
          userNotFoundError: "Die Informationen dieser Person sind nicht verfügbar. Möglicherweise ist sie offline gegangen.",
          notFoundError: "Daten konnten nicht geladen werden für:",
          socketError: "URL für den Websocket ist fehlgschlagen. Verbindung mit der Standard-Addresse ws://localhost:18466 wird aufgebaut."
        },
        filters: {
          ...
          listingsCurated: "Von Läden, welchen ich folge",
          listingsAll: "Von allen Läden"
        },
        nav: {
        ...
        onboarding: {
          ...
          theme: "Wähle ein Theme für deine Seite",
          ...
          disclaimer_body: "OpenBazaar ist ein Netzwerk um Gegenstände und Dienstleistungen zwischen Menschen zu handeln - mit Bitcoin - ohne eine zentrale Organisation, welche die Platform kontrolliert. Dies heißt, dass du verantwortlich für deine Aktivität im Netzwerk bist.<br /><br />OpenBazaar Benutzer sind nicht automatisch anonym. Die meiste Kommunikation zwischen Teilnehmern ist verschlüsselt, aber IP Addressen sind öffentlich und können mit Aktivität auf dem Netzwerk verbunden werden. Bösartige Teilnehmer könnten diese Information gegen dich verwenden; deine Privatspähre zu schützen ist deine eigene Verantwortung.<br /><br />OpenBazaar Benutzer müssen das Gesetz sowie ihr eigenes Gewissen befolgen - und sind nicht verantwortlich für - jegliche Nutzung der Plattform für illegale Aktivitäten.<br /><br />Die OpenBazar Community von Entwicklern hat hart gearbeitet, um eine freie Plattform für Handel in der Welt zu schaffen. Aber so wie mit jeder Software, Bugs werden gefunden werden. Die Entwickler sind nicht verantwortlich für jeglichen finanziellen Verlust verbunden mit Problemen in der Software.<br /><br />Indem du OpenBazaar benutzt, bist du verantwortlich für deine Aktionen auf dem OpenBazaar Netzwerk.",
          yourCountry: "Wähle dein Land",
          localCurrency: "Wähle deine Währung",
          LanguagePlaceholder: "Suche nach Sprache",
          CountryPlaceholder: "Suche nach Land",
          CurrencyPlaceholder: "Suche nach Währung",
          TimezonePlaceholder: "Suche nach Zeitzone",
          timeZone: "Wähle deine Zeitzone",
